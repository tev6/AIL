...
**Where the project is heading right now.** As of cycle 11 (2026-05-15), the AIL team works in named cycles: short bursts where each layer — language, sibling repos, doctrine, contributors — gets tested by the others. The story of how we got here is below, collapsed by default.
