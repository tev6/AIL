...
from .executor_effects import EffectsMixin
...
class Executor(EffectsMixin):
    ...
    # _clock_now lives in executor_effects/clock.py (Stage 1 of split RFC)
...
# --- utilities ---
# Most module-level utility functions extracted to executor_utils.py
# (Stage 0 of executor split RFC). The `_truthy` helper stays here
# because it touches the local ConfidentValue type via isinstance —
# extracting it requires moving ConfidentValue to a types module
# (Stage 1+).
