...
```
~/Desktop/code/personal/AIL/ergon/    ← ergon (primary, .git/ 위치)
~/Desktop/code/personal/AIL/arche/    ← arche
~/Desktop/code/personal/AIL/homeros/  ← homeros
~/Desktop/code/personal/AIL/telos/    ← telos
~/Desktop/code/personal/AIL/tekton/   ← tekton
~/Desktop/code/personal/AIL/<name>/   ← 새로 합류하는 멤버는 모두 여기
```
...
- 결재가 필요한 breaking change (deny-first 같은 grammar 변경 — Polis #4)
